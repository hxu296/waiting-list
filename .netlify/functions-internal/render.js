	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				types: [],
				path: "/manage",
				shadow: () => Promise.resolve().then(() => require('../server/entries/endpoints/manage/index.js')),
				a: [0,8,9],
				b: [1]
			},
			{
				...
				names: [],
				types: [],
				load: () => Promise.resolve().then(() => require('../server/entries/endpoints/api/invite.json.js'))
			},
			{
				type: 'endpoint',
				id: "api/admin.json",
				...
				names: [],
				types: [],
				load: () => Promise.resolve().then(() => require('../server/entries/endpoints/api/admin.json.js'))
			},
			{
				type: 'page',
			...
			},
			{
				...
				types: [],
				path: "/manage/users",
				shadow: () => Promise.resolve().then(() => require('../server/entries/endpoints/manage/users.js')),
				a: [0,8,15],
				b: [1]
			}
		],
